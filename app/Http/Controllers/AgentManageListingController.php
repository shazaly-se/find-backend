...
use DB;
class AgentManageListingController extends Controller
{
    ...
    public function index()
    {
      ...
      $agentpackage= Agent::where('user_id','=',$user->id)->first();
...
//       }
      ...
      ->where('status_id', '=', 1)
      ->where('agent_id','=',$agentpackage->id)
      ->groupBy('status_id')
      ->get();
...
//return $premium_available;
       ...
       ->where('properties.agent_id','=',$agentpackage->id)
